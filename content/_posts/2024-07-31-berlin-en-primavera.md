...
{% stack %}
    {% photo berlin 2024-04-07-Berlin-DSCF1702 class:is-wide %}
{% endstack %}
...
{% stack %}
    {% photo berlin 2024-04-09-Berlin-DSCF1836_2 caption:"Un añito entero pasó aquí, que se dice pronto." class:is-ok %}
{% endstack %}
...
{% stack %}
    {% grid is-vertical %}
        {% photo berlin 2024-04-09-Berlin-R0006908_2 class:is-ok %}
        {% photo berlin 2024-04-10-Berlin-R0006933_2 class:is-ok %}
        {% photo berlin 2024-04-13-Berlin-DSCF1866_2 class:is-ok %}
    {% endgrid %}
{% endstack %}
...
{% stack %}
    {% row %}
        {% photo berlin 2024-04-08-Berlin-R0006902_2 class:is-ok %}
        {% photo berlin 2024-04-13-Berlin-DSCF1900_2 class:is-ok %}
    {% endrow %}
    {% photo berlin 2024-04-05-Berlin-R0006724_2 class:is-ok %}
    {% row %}
        {% photo berlin 2024-04-09-Berlin-R0006910_2 class:is-ok %}
        {% photo berlin 2024-03-30-Berlin-R0006634_2 class:is-ok %}
    {% endrow %}
    {% photo berlin 2024-04-07-Berlin-R0006888 class:is-ok %}
...
{% stack %}
    {% photo berlin 2024-03-31-Berlin-DSCF1393_2 class:is-ok %}
{% endstack %}
...
{% stack %}
    {% stack %}
        {% photo berlin 2024-04-06-Berlin-DSCF1603_2 class:is-ok %}
    {% endstack %}
    {% grid is-square %}
        {% photo berlin 2024-04-13-Berlin-R0006994_2 class:is-ok %}
        {% photo berlin 2024-04-07-Berlin-DSCF1728_2 class:is-ok %}
        {% photo berlin 2024-04-06-Berlin-DSCF1622_2 class:is-ok %}
        {% photo berlin 2024-04-07-Berlin-DSCF1689_2 class:is-ok %}
        {% photo berlin 2024-04-06-Berlin-DSCF1576_2 class:is-ok %}
        {% photo berlin 2024-04-06-Berlin-DSCF1577_2 class:is-ok %}
    {% endgrid %}
    {% stack %}
        {% photo berlin 2024-03-24-Berlin-DSCF1311_2 class:is-ok %}
    {% endstack %}
...
{% stack %}
    {% grid is-half %}
        {% photo berlin 2024-04-06-Berlin-DSCF1666_2 class:is-ok %}
        {% photo berlin 2024-04-06-Berlin-DSCF1647_2 class:is-ok %}
        {% photo berlin 2024-03-31-Berlin-R0006653_2 class:is-ok %}
        {% photo berlin 2024-03-30-Berlin-R0006624_2 class:is-ok %}
        {% photo berlin 2024-04-09-Berlin-DSCF1785 class:is-ok %}
        {% photo berlin 2024-04-09-Berlin-DSCF1777 class:is-ok %}
    {% endgrid %}
...
{% stack %}
    {% photo berlin 2024-03-29-Berlin-R0006620_2 class:is-ok %}
    {% photo berlin 2024-03-31-Berlin-DSCF1533_2 class:is-ok %}
    {% grid %}
        {% photo berlin 2024-03-31-Berlin-DSCF1363_2 class:is-ok %}
        {% photo berlin 2024-03-31-Berlin-DSCF1542 class:is-ok %}
    {% endgrid %}
    {% stack %}
        {% photo berlin 2024-04-13-Berlin-DSCF1910 class:is-ok %}
        {% photo berlin 2024-04-06-Berlin-DSCF1570 class:is-ok %}
    {% endstack %}
...
{% stack %}
    {% photo berlin 2024-04-13-Berlin-DSCF1884_2 class:is-wide %}
{% endstack %}
