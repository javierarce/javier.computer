...
{% stack %}
{% photo mataro 2024-07-07-Mataro-R0007465 class:is-wide %}
{% endstack %}
...
{% stack %}
{% row %}
{% photo mataro 2024-06-26-Mataro-R0007329 class:is-ok %}
{% photo mataro 2024-06-26-Mataro-R0007324 class:is-ok %}
{% endrow %}
{% endstack %}
...
{% stack %}
    {% photo mataro 2024-07-06-Mataro-R0007429 class:is-ok %}
{% endstack %}
...
{% stack %}
{% row %}
{% photo mataro 2024-07-07-Mataro-R0007440 class:is-ok %}
{% photo mataro 2024-07-07-Mataro-R0007441b class:is-ok %}
{% endrow %}
{% endstack %}
...
{% stack with-caption %}
{% row %}
{% photo mataro 2024-06-27-Mataro-R0007342 caption:"La madre de todas las bungavillas" class:is-ok %}
{% photo mataro 2024-06-27-Mataro-R0007343 caption:"La madre de todas las bungavillas" class:is-ok %}
{% endrow %}
<figcaption>La madre de todas las bungavillas</figcaption>
{% endstack %}

{% photo mataro 2024-06-15-Mataro-R0007299 caption:"Laura y Erica de paseo también" class:is-wide %}
...
{% stack %}
    {% photo mataro 2024-06-26-Mataro-R0007335 class:is-ok %}
    {% photo mataro 2024-06-26-Mataro-R0007328 class:is-wide %}
    {% photo mataro 2024-07-07-Mataro-R0007471 class:is-wide %}
    {% photo mataro 2024-07-07-Mataro-R0007478 class:is-wide %}
{% endstack %}
...
{% stack %}
    {% photo mataro 2024-07-07-Mataro-R0007513 class:is-wide %}
{% endstack %}
...
{% stack %}
{% row %}
{% photo mataro 2024-07-05-Mataro-R0007420 class:is-wide %}
{% photo mataro 2024-07-07-Mataro-R0007467 class:is-wide %}
{% endrow %}
{% endstack %}
...
{% stack %}
{% photo mataro 2024-07-07-Mataro-R0007549 class:is-wide %}
{% stack %}
{% row %}
{% photo mataro DSCF1077 class:is-wide %}
{% photo mataro DSCF1103 class:is-wide %}
{% endrow %}
{% endstack %}
{% endstack %}
