...
{% stack %}
    {% photo mataro 2024-12-27-Mataro-R0010409 3/2 alt:"Foto de un panel de información averiado." %}
{% endstack %}
...
{% stack %}
    {% photo badalona 2024-12-27-Badalona-R0010422 3/2 alt:"Foto de un cono en el centro de la acera." %}
    {% row %}
        {% photo badalona 2024-12-27-Badalona-R0010432 2/3 alt:"Foto de tres conos frente al muro de un edificio." %}
        {% photo badalona 2024-12-27-Badalona-R0010428 2/3 alt:"Foto de cuatro conos en el interior de una obra. Detrás de los conos hay una excavadora." %}
    {% endrow %}
...
{% stack %}
    {% photo badalona 2024-12-27-Badalona-R0010459 2/3 alt:"Una persona sentada en un banco mira a su teléfono. Lleva una gorra beige y un pasamontañas de colores. Al fondo se ve la playa y las Tres Chimeneas de Sant Adrià de Besòs." %}
{% endstack %}
...
{% photo badalona 2024-12-27-Badalona-R0010520 2/3 alt:"Foto de un letrero donde se puede leer la palabra 'restaurant' en vertical. Cada letra está dibujada sobre un cubo blanco. El letrero está colgado sobre una pared de ladrillo verde." caption:"Según Scrabble Score Calculator esta palabra te daría, como mínimo, 10 puntos" %}
...
{% stack %}
    {% photo badalona DSCF0955 1/1 alt:"Foto de una pared y el dibujo de una sirena tocando una concha sobre una pared de ladrillo naranja. En la esquina inferior izquierda una chica de espaldas con camisa azul y un bolso naranja le hace una foto con el móvil." caption:"Hay quien también sugiere que es una ninfa acuática con un serio problema de déficit de colágeno." %}
{% endstack %}
...
{% stack %}
    {% photo badalona 2024-12-27-Badalona-R0010473 3/2 alt:"Retrato de Orlando y Laura sentados a la mesa del restaurante mirándose el uno al otro." %}
    {% row %}
        {% photo badalona 2024-12-27-Badalona-R0010472 3/2 alt:"Retrato de Orlando y Laura sentados a la mesa del restaurante. Orlando mira a la cámara y Laura mira a Orlando." %}
        {% photo badalona 2024-12-27-Badalona-R0010471 3/2 alt:"Retrato de Orlando y Laura sentados a la mesa del restaurante mirándose el uno al otro. Laura le está tocando la mejilla a Orlando." %}
    {% endrow %}
{% endstack %}
...
{% stack %}
    {% photo badalona 2024-12-27-Badalona-R0010485 2/3 alt:"Foto de unas casetas de baño al atardecer. En la imagen se pueden ver las puertas azules de entrada. Al fondo de la imagen se ve una farola apagada y parte de algunos edificios." %}
    {% row %}
        {% photo badalona 2024-12-27-Badalona-R0010488 2/3 alt:"Foto de unas casetas de baño al atardecer. Las casetas se ven en el reflejo de un espejo. Al fondo de la imagen se aprecia el mar." %}
        {% photo badalona 2024-12-27-Badalona-R0010496 2/3 alt:"Foto de unas casetas de baño al atardecer. En la imagen se pueden ver las puertas azules de entrada. Al fondo de la imagen se ve parte de un edificio." %}
    {% endrow %}
    {% photo badalona 2024-12-27-Badalona-R0010497 3/2 caption:"International Man of Misery" %}
{% endstack %}
...
{% stack %}
    {% photo badalona 2024-12-27-Badalona-R0010559 3/2 alt:"Foto de una playa y el mar al atardecer, sin nubes, y con una plataforma de madera al fondo." %}
    {% photo badalona 2024-12-27-Badalona-R0010598 2/3 alt:"Foto nocturna de la palabra Peste grafiteada sobre una pared de hormigón" %}
{% endstack %}
