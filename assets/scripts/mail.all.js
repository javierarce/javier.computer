...
class Reader {
  ...
  renderTextarea () {
    ...
    let $label = createElement({ 
      elementType: 'label',
      html: 'Text <div class="Label__help">Include a method of contact if you want a response from me</div>',
      className: 'Label'
    })
  ...
  render () {
    ...
    this.$reader = createElement({ className: this.className })
    ...
    this.$reader.appendChild(this.$form)
    this.$el.appendChild(this.$reader)
  }
}
